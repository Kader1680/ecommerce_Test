    ...
    <div style={{ width:"90%", margin:"auto" }}>
        ...
        <div className=' md:col-span-7 sm:col-span-10 '>
            ...
            <div  className=' absolute   flex items-center gap-3'>
                <Image onClick={changeImage2}  className='productImage' alt='alt'  style={{ borderRadius:"10px", width:"2rem" }}  width={30} height={30} src= "/slide 3.png" />
                <Image onClick={changeImage3} className='productImage' alt='alt'  style={{ borderRadius:"10px", width:"2rem" }} width={30} height={30} src= '/slide1.png' />
                <Image onClick={changeImage1} className='productImage' alt='alt'  style={{ borderRadius:"10px", width:"2rem" }} width={30} height={30} src= '/slide2.png' />
            </div>
            <Comments />
        </div>
