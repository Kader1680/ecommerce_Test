  ...
  return (
    <div>
      <div className=" grid grid-cols-5 bg-white p-3">
        ...
        >
          <h3 className="textHeadDashboard">Groupe</h3>

          <button className=" bg-black text-white p-2 rounded-md fontmd">
            + Create a Customer groupe
          </button>
          <button className=" bg-black text-white p-2 rounded-md fontmd">
            + Create a Customer groupe
          </button>
      ...
      <table className="min-w-full bg-white  p-3">
        <thead>
          <tr style={{ backgroundColor: "#f3f3f3" }}>
            ...
            <th className="p-4  border-b-2 border-gray-200 fontlg">
              Name Groupe
            </th>
            <th className="p-4  border-b-2 border-gray-200 fontlg">
              Customers in groupe
            </th>
            <th className="p-4  border-b-2 border-gray-200 fontlg"> </th>
          </tr>
        </thead>
        <tbody>
          {orders.map((order) => (
            <tr key={order.id} className="text-center">
              ...
              <td className="p-4 border-b fontLg  border-gray-200">
                <span
                  style={{
                    backgroundColor:
                      order.status === "VIP"
                  ...
                  className={` p-2 fontmd rounded-full fontLg   `}
                >
                  {order.status}
                </span>
              </td>

              <td className="p-4 border-b border-gray-200 font-bold">
                {order.brand}{" "}
                <span className=" fontmd text-gray-400">Customers</span>
              </td>
