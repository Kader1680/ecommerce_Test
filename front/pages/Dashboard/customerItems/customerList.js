    ...
    <table className="min-w-full bg-white  p-3">
        <thead>
          <tr style={{ backgroundColor:"#f3f3f3" }}>
            ...
            <th className="p-4  border-b-2 border-gray-200">Location</th>
            <th className="p-4  border-b-2 border-gray-200">Order History</th>
            <th className="p-4 border-b-2 border-gray-200">Group</th>
            <th className="p-4 border-b-2 border-gray-200">Last Purchase</th>
            <th className="p-4  border-b-2 border-gray-200">Actions</th>
          </tr>
        </thead>
        <tbody>
          {orders.map((order) => (
            <tr key={order.id} className="text-center">
              ...
              <td className="p-4 flex items-center   border-b border-gray-200">
                  <Image src={order.user} width={50} height={30} alt='alt' />
                  <p className=' text-sm'>{order.buyer}</p>
                
              </td>
              <td className="p-4  border-b border-gray-200">{order.seller}</td>
