...
function Products() {
  ...
  const orders = [
    ...
    { id: 'Embellished Flare Leg Jeans 90s', buyer: 'Ava Anderson', seller: 'Matthew White', date: '2023-07-25', status: 'Inactive', brand: 'DJI', totalAmount: '$110.00', view: view, edit, edit },

    { id: 'Embellished Flare Leg Jeans 90s', buyer: 'Liam Clark', seller: 'Grace Baker', date: '2023-08-10', status: 'Completed', brand: 'Brand1', totalAmount: '$95.00', view: view, edit, edit },

    { id: 'Embellished Flare Leg Jeans 90s', buyer: 'Chloe Hall', seller: 'Andrew King', date: '2023-09-15', status: 'Completed', brand: 'DJI', totalAmount: '$70.00', view: view, edit, edit },
    { id: 'Embellished Flare Leg Jeans 90s', buyer: 'Mia Scott', seller: 'William Taylor', date: '2023-10-05', status: 'Completed', brand: 'Brand1', totalAmount: '$130.00', view: view, edit, edit },
  ];
  const status = [
    { "state":"all",
      "color":""},
        ...
        <tbody>
          {orders.map((order) => (
            <tr key={order.id} className="text-center">
              ...
              <td className="py-2 px-4 border-b border-gray-200">{order.brand}</td>
